...
vi.mock('lucide-react-native', () => {
  ...
  return { AlertCircle: i('x'), AlertTriangle: i('x'), ArrowRight: i('x'), BedDouble: i('x'), Building2: i('x'), Check: i('x'), CheckCircle: i('x'), ChevronDown: i('x'), ChevronLeft: i('x'), ChevronRight: i('x'), ChevronUp: i('x'), Clock: i('x'), Coffee: i('x'), FileText: i('x'), Fingerprint: i('x'), Flame: i('x'), Heart: i('x'), HelpCircle: i('x'), Inbox: i('x'), Lock: i('x'), LogOut: i('x'), Moon: i('x'), Plus: i('x'), Search: i('x'), ShoppingCart: i('x'), Sun: i('x'), Sunrise: i('x'), User: i('x'), X: i('x') }
})
