import { Modal, View, Text, Pressable, StyleSheet, Platform, KeyboardAvoidingView } from 'react-native'
...
import { space, Typography, BorderRadius, zIndex, spring, color } from '@/src/shared/utils/tokens'
...
export function BottomSheet({
  ...
  const glassBg = isDark ? 'rgba(26,26,26,0.85)' : 'rgba(255,255,255,0.85)'
    ...
    <Modal transparent visible={visible} animationType="none" onRequestClose={onCancel}>
      ...
      <GestureDetector gesture={gesture}>
        <Animated.View
          style={[
            styles.sheet,
            { backgroundColor: glassBg, paddingBottom: Math.max(insets.bottom, space[4]) },
        ...
        >
          {Platform.OS === 'web' ? (
            ...
            <BlurWrapper intensity={80} tint={isDark ? 'dark' : 'light'} style={{ borderRadius: BorderRadius.xl2, overflow: 'hidden' }}>
              {content}
            </BlurWrapper>
          )}
        </Animated.View>
