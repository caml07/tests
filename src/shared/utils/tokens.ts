...
export const Typography = {
  ...
  loraItalic: { fontSize: 15, lineHeight: 20, fontWeight: '500' as const, fontFamily: loraItalic },
  loraCaption: { fontSize: 12, lineHeight: 16, fontWeight: '500' as const, fontFamily: loraItalic },
  loraLabel: { fontSize: 13, lineHeight: 18, fontWeight: '500' as const, fontFamily: loraItalic },
  label: { fontSize: 12, lineHeight: 16, fontWeight: '600' as const, fontFamily, letterSpacing: 0.5 as const },
  ...
  italic: { fontSize: 15, lineHeight: 20, fontWeight: '500' as const, fontFamily: loraItalic },
